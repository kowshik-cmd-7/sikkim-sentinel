...
export const TEMPLATES: Record<AlertLanguage, Dict> = {
  ...
  hi: {
    severity: { low: "कम", moderate: "मध्यम", high: "उच्च", severe: "गंभीर" },
  ...
  ne: {
    severity: { low: "न्यून", moderate: "मध्यम", high: "उच्च", severe: "गम्भीर" },
  ...
  te: {
    severity: { low: "తక్కువ", moderate: "మధ్యస్థం", high: "అధికం", severe: "తీవ్రం" },
